    ...
    public class VNPAYService {
        ...
        public String createOrder(HttpServletRequest request, Long orderId, String urlReturn){
            ...
            BigDecimal vnpAmount = o.getTotalPrice().multiply(BigDecimal.valueOf(100)); // Nhân với 100
            String vnpAmountString = vnpAmount.toBigInteger().toString(); // Chuyển thành chuỗi số nguyên

            Map<String, String> vnp_Params = new HashMap<>();
            vnp_Params.put("vnp_Version", vnp_Version);
            vnp_Params.put("vnp_Command", vnp_Command);
            vnp_Params.put("vnp_TmnCode", vnp_TmnCode);
            vnp_Params.put("vnp_Amount", vnpAmountString); // Sử dụng chuỗi số nguyên
